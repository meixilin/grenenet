...
plotdir = paste0('plots/ver202209/LMM/', envvar, '/part2/')
...
lmres = format_lmres(lmres0,genecoordsdt,p_adjmethods = 'fdr')
dim(lmres)
head(lmres)
tail(lmres)
